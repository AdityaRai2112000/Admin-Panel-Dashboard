    ...
    template:
      ...
      `
        <div style="text-align:left">
          <p style="margin:0;font-weight:500">\${CustomerName}</p>
          <p style="margin:0;font-size:12px;color:#6b7280">\${CustomerEmail}</p>
        </div>
      </div>
    `,
  },
...
export const ordersGrid = [
  {
    ...
    textAlign: "Center",
    template:
      '<img src="${ProductImage}" style="height:80px;border-radius:12px;margin-left:12px" />',
  },
  {
    field: "OrderItems",
    headerText: "Item",
  ...
  },
  {
    ...
    textAlign: "Center",
    template:
      '<span style="background:${StatusBg};color:white;padding:4px 10px;border-radius:16px;text-transform:capitalize">${Status}</span>',
  },
  {
    field: "OrderID",
    headerText: "Order ID",
