  ...
  return (
    <div className="mt-24">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div
          className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center shadow-lg"
          style={{
          ...
          {earningData.map((item) => (
            ...
            >
              <button
                ...
                className="text-3xl opcacity-0.9 rounded-full p-4 hover:drop-shadow-xl"
              >
                {item.icon}
              </button>
              <p className="mt-3">
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className=" bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780 shadow-lg">
          ...
          <div className="container flex md:flex-row flex-col items-center gap-20">
            <div className="mt-10 flex-col pl-6 gap-10 flex-wrap justify-center">
              <div>
                <p>
            ...
            <div className="h-75 w-px bg-[#808080] hidden md:block  "></div>
            {/* Stacked Component  */}
            <div>
